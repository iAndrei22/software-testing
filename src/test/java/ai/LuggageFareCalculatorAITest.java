...
public class LuggageFareCalculatorAITest {
     ...
     */
    @Test
    @DisplayName("Condition Coverage: Validarea taxelor pentru pasagerii VIP peste limitele extinse")
    void testCalculateTotalFeeVipIgnoresFees() {
        // Pasager VIP, Economy. Are dreptul la 2 bagaje gratuite (1 standard + 1 VIP bonus).
        vipPassenger.addLuggage(25.0); // Index 0: Gratuit (greutate ok pentru VIP/Business limit: 32.0)
        vipPassenger.addLuggage(20.0); // Index 1: Gratuit (al doilea bagaj gratuit pentru VIP)
        vipPassenger.addLuggage(20.0); // Index 2: Extra bag (peste cele 2 gratuite) -> Taxă 100.0

        // Noua logică: VIP primește 2 bagaje gratuite în Economy. Al treilea este taxat.
        double fee = vipPassenger.calculateTotalFee();
        assertEquals(100.0, fee, "Sistemul ar trebui să aplice taxa de extra bagaj pentru al treilea bagaj al unui VIP la Economy.");
    }
